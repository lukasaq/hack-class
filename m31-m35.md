...
Regarding Figure A in the attached CWP 3-33.4, the on-site stage correlates to Step 5 of the CPT Operations Process.
...
The DeTT&CT framework is a tool for comprehensive examinations of security architecture visibility and detection of TTPs on the MITRE ATT&CK framework. DeTT&CT considers an organization’s data sources, collection quality, and templated threats. The DeTT&CT framework visualizes risk through the lens of threat intelligence by using the MITRE ATT&CK framework to map between data sources, TTPs, and threat actors. 
...
Procedures and communications may be proactive or reactive. Proactive procedures and communications are those that are made in an effort to prevent incidents from happening in the future. Reactive procedures and communications are those that occur as a result of an incident.
...
Two key resources developed by NIST are as follows:
...
The NIST RMF process integrates privacy, security, and cyber supply chain risk management activities into the system development life cycle. The RMF helps organizations make decisions about risk mitigation strategies. 

﻿

The seven steps of the NIST RMF are as follows:

Prepare: The organization defines and collects critical information that may be needed to determine an RMP. 
Categorize: The organization categorizes all available information on the threat sources, threat events, vulnerabilities, and predisposing conditions. 
Select: the organization defines the defensive posture strategy by identifying the specific TTPs needed to diminish threat sources and threat events.
Implement: The organization executes the defensive posture strategy using findings from the previous step.
Assess: The organization uses data from sources, such as security control assessments, to determine the effectiveness of the defensive posture.
Authorize: Leaders make risk-based decisions to authorize and operate the system, or to provide additional security controls.
Monitor: The organization updates risk assessments on an ongoing basis using security-related information from continuous monitoring processes.
NIST Special Publication 800-30
﻿

The NIST Special Publication 800-30 provides guidance on conducting risk assessments.

﻿

The publication explains that the risk assessment is conducted on the following three levels of the risk management hierarchy:

Tier 1, Organization 
Tier 2, Mission and business process
Tier 3, Information systems
The goal of the assessment is to provide leaders the proper information required to make RMP decisions and determine implementation strategies. 

﻿

The publication provides guidance on the following four steps to complete the risk assessment:
...
Preparing for the Assessment
The objective of this step is to establish a context for the risk assessment. At this step, the organization must define policies and requirements for conducting the risk assessment. The organization must also define the parameters regarding the assessment, such as the methodology, procedures, scope, rigor, degree of formality, source information, and type of risk model. 

﻿

Conducting the Assessment
The objective of this step is to produce a list of information security risks, prioritized by risk level, to aid in making risk response decisions. The organization analyzes threats, vulnerabilities, and their likelihood and impact to the organization. The organization must define the threat sources, threat events, vulnerabilities, impact, and likelihood of the risk. 

﻿

Communicating the Results of the Assessment
The objective of this step is to ensure that the decision-making parties within the organization have the information they need to make well-informed decisions. At this step, the risk assessment results are communicated, and information collected during the assessment is shared.

﻿

Maintaining the Assessment
The objective of this step is to preserve and maintain knowledge of the risks posed to the organization. At this step, the organization maintains the risk assessment and updates it based on any changes detected through risk monitoring.

-----------

Create an RMP
Read the following scenario and complete the workflow. 
...
The CDAH Organization consists of five business departments, with about 200-300 users total. The mission of the CDAH Organization is to provide business administration support to the Cyber Defense Analyst (CDA) Command. 

﻿

As a result of their operational tasks, the CDAH Organization maintains large amounts of sensitive information. The CDAH Organization uses TIA System 626 for real-time network monitoring. TIA System 626 includes the organization's Elastic Stack instance and enables security analysts to analyze data and log files in real time.

﻿

Leadership in the CDAH Organization recently conducted a threat assessment of TIA System 626 to better understand risk exposure of the system. 

﻿

Leadership needs a RMP developed for TIA System 626. 

﻿

Access and analyze the threat assessment report. Use the information to create an RMP for the system.
...
1. Log on to cdah-wks0 Virtual Machine (VM) with the following credentials:

Username: trainee
Password: CyberTraining1!
﻿

2. Open the TIA System 626 Threat Assessment Report.pdf from the 

C:\Users\trainee\Desktop\Threat Assessment\TIA System 626 Threat Assessment Report.pdf path.

﻿

3. Analyze the TIA System 626 Threat Assessment Report.pdf document. 

﻿

Use the threat assessment report to answer the following questions and create an RMP
...
RMP Summary
RMPs differ due to the details of each risk. The overall RMP strategy must address the risk and produce minimal impact to the organization. 

﻿

Table 34.3-1 below displays the risk assessment results


<img width="2500" height="969" alt="image" src="https://github.com/user-attachments/assets/0d5b0400-55d5-41ac-8792-dc3ff8925595" />


The RMP must not increase the risk level to the organization. For example, providing no server room access would prevent any malicious access to the Information System (IS). However, over time, the software and hardware would become outdated by being free from patches or upgrades. As a result, the server would be exposed to new adversarial techniques. 


Table 34.3-2 below displays the RMP for TIA System 626



<img width="3335" height="1765" alt="image" src="https://github.com/user-attachments/assets/affefb41-6be5-431f-8f75-810f44dd705d" />

Each mitigation strategy addresses the risk, lowers the risk value, and allows the CDAH Organization to operate with minimal disruption
